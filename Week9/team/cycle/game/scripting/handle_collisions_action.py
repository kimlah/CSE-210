...
class HandleCollisionsAction(Action):
    ...
    with the other cycle's trail or the game is over.
    ...
    def _handle_cycle_collision(self, cast):
        """Updates the score if the cycle collides with the other cycle.
